...
export function Detail() {
    ...
    // Só renderiza na tela após tudo ser executado e montado
    useLayoutEffect(() => {
    ...
    return (
        <ScrollView 
            ...
            contentContainerStyle={{ paddingBottom: 20 }} //Ao final do ScrollView, um pequeno espaçamento interno
        ...
        >
            ...
            {/* Percorre a lista de ingredientes e renderiza todos na tela */}
...
const styles = StyleSheet.create({
    ...
    playIcon: {
        // Alinhando o ícone ao centro na imagem
        position: 'absolute',
        zIndex: 9,
